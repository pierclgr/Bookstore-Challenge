...
5. Launch *Docker* app.
6. Move to the repository directory and run `docker-compose up --build`; this will take a while.
7. When the build finishes, open [localhost:3000](http://localhost:3000) on your browser to access the app.
